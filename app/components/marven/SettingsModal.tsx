          ...
          <div className="space-y-5">
            ...
            <div className="rounded-lg border border-[#2a2a2a] bg-[#1e1e1e] p-4 space-y-3">
              <div className="flex items-center justify-between">
                <p className="font-mono text-[9px] tracking-[0.2em] text-[#555] uppercase">
                  Software Update
                </p>
                {version && (
              ...
              {updateStatus === "ready" && (
                <div className="space-y-2">
                  <p className="font-mono text-[11px] text-[#d19a66]">
              ...
              {updateStatus === "up-to-date" && (
                <p className="font-mono text-[11px] text-[#555]">
                  Marven is up to date.
                </p>
              )}

              {updateStatus === "error" && (
                <p className="font-mono text-[11px] text-red-400/70 break-all">
                  {updateInfo?.message}
                </p>
              )}
      ...
      <aside className="flex w-[220px] shrink-0 flex-col overflow-y-auto bg-[#181818] border-r border-[#2a2a2a] py-4">
        {SECTIONS.map((section) => (
          <div key={section.heading} className="mb-4">
            <p className="px-4 pb-1.5 font-mono text-[9px] tracking-[0.15em] text-[#555] uppercase">
              {section.heading}
            </p>
              ...
              return (
                <button
                  ...
                  className={`relative w-full text-left px-4 py-2 text-[13px] transition-colors ${
                    isActive
                      ? "bg-[#252525] text-[#d19a66] border-l-2 border-[#d19a66]"
                      : "text-[#888] hover:bg-[#1e1e1e] hover:text-[#d4d4d4] border-l-2 border-transparent"
                  }`}
                >
                  {item.label}
                </button>
