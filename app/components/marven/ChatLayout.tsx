...
export function ChatLayout({
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-[#1a1a1a] text-[#d4d4d4]">
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          {mode === "agent" ? (
            ...
            /* Chat-mode settings — takeover (matches agent-mode tab style) */
            <div className="flex h-full min-h-0 flex-col bg-[#1a1a1a]">
              <div className="flex items-stretch border-b border-[#333] bg-[#1a1a1a]">
                <div className="relative flex items-center gap-2 border-r border-[#333] bg-[#1e1e1e] px-3 py-2">
                  ...
                  <span className="absolute top-0 left-0 right-0 h-[2px] bg-[#d19a66]" />
                </div>
              </div>
      ...
      {/* Settings is rendered inline in both modes (agent: editor tab, chat: full takeover) */}
    </div>
  );
}
